...
namespace NSW
{
    public partial class SiteMaster : System.Web.UI.MasterPage
    {
        ...
        private void setText()
        {
            ...
            if (Page.User.Identity.IsAuthenticated)
            {
                ...
                if (cacheUser.ID > 0)
                {
                    ...
                    if (cacheUser.UserRole == Role.Admin)
                    {
                        ...
                        MenuItem numbersItem = new MenuItem(NSW.Data.LabelText.Text("Master.btnNumbers"), null, null, "~/Admin/NumbersPage.aspx");
                        MenuItem testItem = new MenuItem(NSW.Data.LabelText.Text("Master.btnTest"), null, null, "~/Admin/Test/Default.aspx");
                        adminItem.ChildItems.Add(labelItem);
                        adminItem.ChildItems.Add(categoryItem);
                        adminItem.ChildItems.Add(numbersItem);
                        adminItem.ChildItems.Add(testItem);
            ...
            // ad banner
            this.arMainAd1.AdvertisementFile = "~/App_Data/ads/ads1.xml";
            // footer
