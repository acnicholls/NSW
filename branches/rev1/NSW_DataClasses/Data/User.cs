    ...
    public class User
    {
        ...
        public User(string username, string password)
        {
            try
            {
                ...
                SqlDataAdapter adap = new SqlDataAdapter(userComm);
                userComm.CommandType = CommandType.Text;
                userComm.CommandText = "Select * from tblUsers where fldUser_Email='" + username + "' and fldUser_Password='" + password + "'";
                // first find the user row in the database
                userConn.Open();
                adap.Fill(ds);
                userConn.Close();
        ...
        public User(string username)
        {
            try
            {
                ...
                SqlDataAdapter adap = new SqlDataAdapter(userComm);
                userComm.CommandType = CommandType.Text;
                userComm.CommandText = "Select * from tblUsers where fldUser_Email='" + username + "'";
                // first find the user row in the database
                userConn.Open();
                adap.Fill(ds);
                userConn.Close();
